...
public class PhotoWallActivity extends AppCompatActivity {
    ...
    public final static String[] imageThumbUrls = new String[] {
            "http://pic.element3ds.com/forum/201608/15/232852lktpzqsqgjtqtqq3.png",
            "http://pic.element3ds.com/forum/201608/15/232852lktpzqsqgjtqtqq3.png",
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PhotoWallAdapter adapter = new PhotoWallAdapter(PhotoWallActivity.this,0,imageThumbUrls,photoWall);
    ...
    public class PhotoWallAdapter extends ArrayAdapter<String> implements AbsListView.OnScrollListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View view;
            if (convertView == null) {
                view = LayoutInflater.from(getContext()).inflate(R.layout.photoitem, null);
            } else {
                view = convertView;
            }
        ...
        private void setImageView(String imageUrl, ImageView imageView) {
            ...
            if (bitmap != null) {
                ...
                imageView.setImageResource(R.drawable.add_memo);
            }
        }
